    ...
    for line in passphrases:
        ...
        for w in words:
            if w not in lst:
                ...
                break
        del lst
    result = len(passphrases) - wrong_passphrases
    print("Adott a jelmondatok egy teljes adatbázisa. Ezek közül hány jelmondat érvényes?")
    print(f"Érvényes jelmondatok száma: {result}")
